 ...
 * @author chame
 */
public class year3_semi2 extends javax.swing.JFrame {
   ...
   PreparedStatement pst1 = null;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Student Profile - Year 3 Semester 2");
        ...
        yearsembox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Year 3 Semester 2", "Year 4 Semester 1", "Year 4 Semester 2" }));
        ...
        jLabel12.setText("ENGL 32153(C)");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("ENGL 32133(C)");

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("ENGL 32143(C)");
        ...
        jLabel16.setText("ENGL 32163(C)");

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("ENGL 32313(E)");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(146, 146, 146)
                .addComponent(depbox, javax.swing.GroupLayout.PREFERRED_SIZE, 480, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(74, 74, 74))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       int credit7 =(Integer)AC7.getValue();
         ...
         year3_semi2 hell= new year3_semi2();
    ...
    public float gpa(String gradeLetter1,String gradeLetter2,String gradeLetter3,String gradeLetter4,String gradeLetter5,String gradeLetter6,String gradeLetter7,int credit1,int credit2,int credit3,int credit4,int credit5,int credit6,int credit7)
{
  ...
  float crd7=(float)credit7;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String q1 = "INSERT INTO year3sem2 (SID,ENGL32133,ENGL32143,ENGL32153,ENGL32163,ENGL32313,PCEN12333,PCEN11323) values ('"+ sid +"','"+ s1 +"','"+ s2 +"','"+ s3 +"','"+ s4 +"','"+s5+"','"+s6+"','"+s7+"');";
    ...
    private void grade1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grade1MouseClicked
        ...
        try{
         Statement stmt =con.createStatement();
         rs=stmt.executeQuery("SELECT Credit FROM subject WHERE Scode = 'ENGL32133' ");
    ...
    private void grade2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grade2MouseClicked
        ...
        try{
         Statement stmt =con.createStatement();
         rs=stmt.executeQuery("SELECT Credit FROM subject WHERE Scode = 'ENGL32143' ");
    ...
    private void grade3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grade3MouseClicked
        ...
        try{
         Statement stmt =con.createStatement();
         rs=stmt.executeQuery("SELECT Credit FROM subject WHERE Scode = 'ENGL32153' ");
    ...
    private void grade4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grade4MouseClicked
        ...
        try{
         Statement stmt =con.createStatement();
         rs=stmt.executeQuery("SELECT Credit FROM subject WHERE Scode = 'ENGL32163' ");
    ...
    private void grade5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grade5MouseClicked
        ...
        try{
         Statement stmt =con.createStatement();
         rs=stmt.executeQuery("SELECT Credit FROM subject WHERE Scode = 'ENGL32313' ");
